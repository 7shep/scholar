...
- [x] Add documented Supabase schema updates for persisted assignment grade fields.
- [x] Extend the shared assignment data layer to load and update assignment grades.
- [x] Add shared signed-in navigation state for the `Grades` view in the existing shell.
